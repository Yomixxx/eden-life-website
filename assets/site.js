...
(function () {
  ...
  if (giveForm) {
    ...
    const FLW_PUBLIC_KEY = 'FLWPUBK-958c81a77b337a58b3fb66b8fd44fef3-X';
  ...
  function createWhatsAppFloat() {
    const waUrl = 'https://wa.me/2349097209484';
    ...
    wa.addEventListener('click', (e) => {
      ...
      e.preventDefault();
      gtag('event', 'ads_conversion_Contact_Us_1', {});
      // Delay navigating to WhatsApp until the conversion hit is sent (or
      // 2s elapses), so the browser doesn't cancel it mid-flight.
      gtag('event', 'conversion_event_book_appointment', {
        event_callback: function () { window.location = waUrl; },
        event_timeout: 2000,
      });
    });
