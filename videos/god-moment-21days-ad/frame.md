...
description: >
  ...
  ink black / warm cream), Montserrat uppercase tracked + Montserrat body, the 45° diagonal hatch,
...
typography:
  # — reading ramp (Poppins, the site's body font) —
  body:          { fontFamily: "Poppins", cqw: 1.0,  weight: 400, lineHeight: 1.7 }
  body-light:    { fontFamily: "Poppins", cqw: 1.5,  weight: 300, lineHeight: 1.5, note: "pull-quote voice" }
  section-label: { fontFamily: "Poppins", px: 12, weight: 700, tracking: "4px", upper: true }
  item-label:    { fontFamily: "Poppins", px: 11, weight: 700, tracking: "3px", upper: true }
  quote-attribution: { fontFamily: "Poppins", px: 14, weight: 600, tracking: "3px", upper: true }
  quote-role:    { fontFamily: "Poppins", px: 12, weight: 400, tracking: "1px" }
  # — display / hero ramp (Montserrat, uppercase, tracked) —
  card-title:    { fontFamily: "Montserrat", cqw: 1.9, weight: 400, lineHeight: 1.1, tracking: "1px", upper: true }
  sidebar-value: { fontFamily: "Montserrat", cqw: 2.3, weight: 400, lineHeight: 1.0, upper: true }
  bar-title:     { fontFamily: "Montserrat", cqw: 2.3, weight: 400, lineHeight: 1.0, tracking: "2px", upper: true }
  card-stat:     { fontFamily: "Montserrat", cqw: 2.5, weight: 400, lineHeight: 1.0, upper: true }
  column-title:  { fontFamily: "Montserrat", cqw: 3.7, weight: 400, lineHeight: 1.0, tracking: "2px", upper: true }
  section-headline:{ fontFamily: "Montserrat", cqw: 4.2, weight: 400, lineHeight: 1.0, tracking: "2px", upper: true }
  stat-numeral:  { fontFamily: "Montserrat", cqw: 5.0, weight: 400, lineHeight: 1.0, upper: true }
  hero-title:    { fontFamily: "Montserrat", cqw: 6.5, weight: 400, lineHeight: 0.9, tracking: "4px", upper: true }
  jumbo-feature: { fontFamily: "Montserrat", cqw: 9.0, weight: 400, lineHeight: 1.0, tracking: "12px", upper: true }
  # — decorative —
  background-numeral: { fontFamily: "Montserrat", cqw: 10.0, weight: 400, color: "rgba(0,0,0,0.12)", note: "wallpaper numeral inside a coral region" }
  giant-mark:    { fontFamily: "Montserrat", cqw: 14.0, weight: 400, color: "rgba(0,0,0,0.35)", note: "decorative quote mark inside a coral region" }
...
components:
  ...
  info-bar:
    ...
    rounded: "0"
    shadow: "none"
    description: "Footer band beneath a feature region — Bebas title left, Montserrat meta right."
---
...
- **Fonts** — already set to **Montserrat** (display) / **Poppins** (body); ignore any preset font name lingering in prose.
...
The voice is a two-face hierarchy: **Montserrat** — tall condensed caps, always uppercase, always
tracked (1–12px) — carries every headline, stat, title, and meta figure; **Montserrat** carries every
body line, label, and attribution across weights 300–700. Bebas declares; Montserrat explains. The
...
- **Bebas uppercase + tracking** on every display element; **Montserrat** on every body/label.
...
Two ramps. The **reading ramp** (Montserrat body 1.0cqw, body-light 1.5cqw, labels in px) carries copy
...
- **Every Bebas element is uppercase with ≥1px tracking** (2px standard, 4px hero, 12px jumbo). **Every Montserrat label is uppercase, 1–4px tracked.** No italic, no underline, no sentence-case Bebas.
...
ink `section-label` eyebrow; an optional Montserrat-300 support line ≤44cqw. **Accent** the coral ground
...
**Focal** a 2–3 line pull quote in `{colors.cream}` Montserrat **weight 300** on the ink panel.
...
mark. **Fixed** Montserrat-300 quote, ink panel, ink-on-coral mark. **Free** quote, attribution, mark
...
Bebas title, Montserrat body, coral stat). **Accent** the three coral top borders + icon squares.
...
- Set every Bebas element **uppercase + tracked** (2px standard, 4px hero, 12px jumbo); every Montserrat label uppercase, 1–4px.
...
- Don't render Bebas in sentence case or untracked; don't pair it with a non-Montserrat body sans.
...
- **Montserrat + Montserrat via Google Fonts.** CJK pairing (ZCOOL XiaoWei / Yozai) carries over from the source's CJK section; Bebas runs ~20% wider in CJK.
