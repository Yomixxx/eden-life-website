...
description: >
  ...
  are identical and sacred — the green/pink/cream editorial triad, Poppins at weight 500
...
typography:
  ...
  # — display ramp (Montserrat, the site's real display font) —
  title-card-sm:{ fontFamily: "Montserrat", cqw: 2.9, weight: 700, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Montserrat", cqw: 3.5, weight: 700, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Montserrat", cqw: 4.4, weight: 800, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Montserrat", cqw: 5.0, weight: 800, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Montserrat", cqw: 7.3, weight: 800, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Montserrat", cqw: 11.5, weight: 900, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Montserrat", cqw: 11.5, weight: 900, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Montserrat", cqw: 5.7, weight: 700, lineHeight: 0.92 }
  name:    { fontFamily: "Poppins", cqw: 2.3, weight: 600, lineHeight: 1.0 }
...
- **Fonts** — already set to **Poppins** (display) / **Montserrat** (body); ignore any preset font name lingering in prose.
...
Penguin classic or a quiet annual report. One confident voice, **Poppins at weight 500**
...
- **Poppins weight 500** (opsz, negative tracking) for all display; **serif 400** body; **JetBrains Mono 500** uppercase chrome.
...
- **Squint** — one Poppins moment dominates at 3–6× its neighbor; the surface block centers the eye.
...
Two ramps. The **reading/chrome ramp** (Poppins **400** body 1.56cqw; JetBrains Mono labels
in px) carries copy + chrome; the **display ramp** (Poppins **500** `title-card-sm` 2.9cqw →
...
- Run every display in **Poppins weight 500**, opsz, negative-tracked, tight line-height; **body at 400**.
...
- **Type** — Poppins **500** display (opsz, negative-tracked) / **400** body; mono uppercase 0.08–0.18em; ≥1.4cqw floor.
...
- **Poppins (opsz 8..60) + JetBrains Mono via Google Fonts** — the optical-size axis is critical; a non-opsz fallback flattens the size-aware letterforms. CJK: LXGW WenKai (display) / Noto Serif SC (body) / Noto Sans Mono CJK (chrome).
